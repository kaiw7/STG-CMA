...
from traintest_adapt_ave29 import train, validate #todo our final setting
...
parser.add_argument("--dataset", type=str, default="audioset", help="the dataset used", choices=["audioset", "esc50", "speechcommands", "fsd50k", "vggsound", "epic", "k400", 'ks-32', 'ucf101', 'hmdb51', 'ave-29'])
...
if args.model == 'MM-CLIP-AVE-Base':
    print('finetune CLIP 12 modality-specific layers')
    audio_model = model.CLIP_AVE.MM_CLIP_AVE(label_dim=args.n_class,
                                  layers=12,
                                  num_video_frames=10,
                                  embed_dim=768,
                                  patch_size=16,
    ...
    audio_model = model.Swin_AVE.SwinTransformer2D_Adapter_New(label_dim=args.n_class,
                                                   patch_size=[1, 4, 4],
                                                   num_frames=10,
                                                   embed_dim=128,
                                                   depths=[2, 2, 18, 2],
