...
parser.add_argument("--dataset", type=str, default="audioset", help="the dataset used", choices=["audioset", "esc50", "speechcommands", "fsd50k", "vggsound", "epic", "k400", 'ks-32', 'ucf101', 'hmdb51', 'ave-29', 'avsbench'])
...
if args.model == 'MM-Swin-AVS-Base':
