...
def extract_frames(root_path="./STG-CMA/AVS/dataset/Single-source/s4_data",\
                   csv_path="./STG-CMA/AVS/dataset/Single-source/s4_meta_data.csv"):
...
def extract_audio_wav(root_path="./STG-CMA/AVS/dataset/Single-source/s4_data",\
                   csv_path="./STG-CMA/AVS/dataset/Single-source/s4_meta_data.csv"):
...
def extract_audio_log_mel(root_path="./STG-CMA/AVS/dataset/Single-source/s4_data",\
                   csv_path="./STG-CMA/AVS/dataset/Single-source/s4_meta_data.csv"):
