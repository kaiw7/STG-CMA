...
def extract_frames(root_path="./STG-CMA/AVS/dataset/Multi-sources/ms3_data"):
...
def extract_audio_wav(root_path="./STG-CMA/AVS/dataset/Multi-sources/ms3_data",\
                   csv_path="./STG-CMA/AVS/dataset/Multi-sources/ms3_meta_data.csv"):
...
def extract_audio_log_mel(root_path="./STG-CMA/AVS/dataset/Multi-sources/ms3_data",\
                   csv_path="./STG-CMA/AVS/dataset/Multi-sources/ms3_meta_data.csv"):
