...
class SwinTransformer2D_Adapter_AVS_Base(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, pretrained=None, img_size=224, patch_size=[1, 4, 4], num_frames=5, in_chans=3,
        ...
        # todo for swin base checkpoint
        self.avstask_x1_linear = nn.Linear(128, 64)  # todo input dimension 128
        self.avstask_x2_linear = nn.Linear(256, 128)  # todo input dimension 256
        self.avstask_x3_linear = nn.Linear(512, 320)  # todo input dimension 512
        self.avstask_x4_linear = nn.Linear(1024, 512)  # todo input dimension 1024

        self.avstask_audio_linear = nn.Linear(1024, 128) # todo 1024
